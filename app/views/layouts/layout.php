...
// Parse dynamic hero/accent hex color to RGB integers for variable alpha layers
$accent_hex = $data['hero_color'] ?? '#6A5AE0';
$clean_hex = str_replace('#', '', $accent_hex);
...
<head>
    <style>
        :root {
            --page-accent: #<?= $clean_hex ?> !important;
            --page-accent-rgb: <?= $rgbString ?> !important;
        }
    </style>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="robots" content="index, follow">
    <meta name="author" content="Crea8ve Cool">
    <link rel="publisher" href="https://linkedin.com/company/crea8ve-cool">
    ...
    <meta property="og:title" content="<?= htmlspecialchars($data['meta_title'] ?? $data['title']) ?>">
    ...
    <meta property="twitter:title" content="<?= htmlspecialchars($data['meta_title'] ?? $data['title']) ?>">
    ...
    <title><?= htmlspecialchars($data['meta_title'] ?? $data['title']) ?></title>
    ...
    <!-- Preconnect to high-priority CDN origins to resolve LCP & FCP latency early -->
    ...
    <!-- Bootstrap Icons (Asynchronous non-render-blocking) -->
    ...
    <!-- AOS (Asynchronous non-render-blocking) -->
    ...
    <!-- Google Fonts & Fontshare for Clash Display (Asynchronous non-render-blocking) -->
    <link rel="preload" href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&family=Montserrat:wght@400;500;600;700;800;900&display=swap" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&family=Montserrat:wght@400;500;600;700;800;900&display=swap" rel="stylesheet"></noscript>
    
    <link rel="preload" href="https://api.fontshare.com/v2/css?f%5B%5D=clash-display@400,500,600,700,800&display=swap" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link href="https://api.fontshare.com/v2/css?f%5B%5D=clash-display@400,500,600,700,800&display=swap" rel="stylesheet"></noscript>
    ...
    <link href="<?= BASE_URL ?>public/assets/css/<?= htmlspecialchars($data['page_css']) ?>?v=<?= filemtime(PUBLIC_PATH . '/assets/css/' . $data['page_css']) ?>" rel="stylesheet">
    <?php endif; ?>
...
<a href="https://wa.me/919972988194" target="_blank" class="floating-whatsapp" title="Chat with us on WhatsApp">
...
<script src="<?= BASE_URL ?>public/assets/js/main.js?v=<?= filemtime(PUBLIC_PATH . '/assets/js/main.js') ?>" defer></script>
<?php if (isset($data['page_js'])): ?>
<script src="<?= BASE_URL ?>public/assets/js/<?= htmlspecialchars($data['page_js']) ?>?v=<?= filemtime(PUBLIC_PATH . '/assets/js/' . $data['page_js']) ?>" defer></script>
<?php endif; ?>
<script>
