<?php 
// Hardcoded Service Data for Website Designing (Fast Approach)
$serviceSlug = 'website';
$accentColor = '#6A5AE0'; // Brand Purple/Blue
$service = [
    ...
    'packages' => [
        [
            ...
            'desc' => 'High-impact landing page to validate your idea.',
            'price' => '14,999',
            'original_price' => '25,000',
            'savings' => '40',
            'color' => '#111111',
            'recommended' => false,
            'features' => ['Single Page Layout', 'Mobile Responsive', 'Contact Form', 'Basic SEO', '1 Week Delivery']
        ],
        [
            'name' => 'Growth Engine',
            'tagline' => 'Most Popular',
            'desc' => 'Complete CMS website built for lead generation.',
            'price' => '29,999',
            'original_price' => '50,000',
            'savings' => '40',
            'color' => '#6A5AE0',
            'recommended' => true,
            'features' => ['Up to 10 Pages', 'WordPress CMS', 'Advanced SEO setup', 'Speed Optimized', 'Blog Integration']
        ],
        [
            'name' => 'Scale & Dominate',
            'tagline' => 'Enterprise',
            'desc' => 'Custom MVC architecture for massive scale.',
            'price' => '79,999',
            'original_price' => '120,000',
            'savings' => '33',
            'color' => '#FF007A',
            'recommended' => false,
            'features' => ['Custom PHP/React', 'Unlimited Pages', 'Webhooks/API', 'Custom Dashboard', 'Dedicated Support']
        ]
    ]
];
...
if (isset($data['location'])) {
    $loc = $data['location'];
    $service['title'] = $loc['headline'];
    $service['desc'] = $loc['hook'];
    $service['meta_title'] = $loc['headline'] . " | Crea8ve Cool";
    $service['meta_description'] = "Looking for " . $loc['headline'] . "? " . $loc['hook'] . " Contact us today for a custom web engineering session.";
...
$locationContext = 'India'; // ← Override in each location page copy
?>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-6" data-aos="fade-up">
                <div class="pitch-card p-5 border-3 border border-dark rounded-5 h-100 transition-all bg-light">
                    ...
                    <p class="text-muted mb-4 fs-5">A website is your 24/7 salesperson. We design intuitive, <strong>User-Friendly Websites</strong> that prioritize the <a href='https://www.nngroup.com/articles/definition-user-experience/' target='_blank' rel='noopener noreferrer' title='External Resource: NNGroup User Experience Definition' class='text-dark fw-bold text-decoration-underline'>visitor's journey</a>. By streamlining navigation and clarifying calls-to-action, we ensure your audience stays engaged. This is the core of our <a href='<?= BASE_URL ?>services/uiux' title='Explore our UI/UX Strategy Services' class='text-accent-dynamic fw-bold'>UI/UX Strategy</a>, ensuring your brand resonates with every click.</p>
            ...
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                <div class="pitch-card p-5 border-3 border border-dark rounded-5 h-100 transition-all bg-white shadow-punchy-sm">
                    ...
                    <p class="text-muted mb-4 fs-5">In today's mobile-first world, your site must be flawless on every screen. Our <strong>Mobile-Optimized Designs</strong> adapt perfectly to any device, providing a <a href='<?= BASE_URL ?>services/pwa' title='Learn about Progressive Web Apps' class='text-accent-dynamic fw-bold'>Native-App Experience</a>. We focus on touch-friendly interfaces and rapid mobile rendering, as outlined in <a href='https://developers.google.com/search/mobile-sites/mobile-first-indexing' target='_blank' rel='noopener noreferrer' title='Google Search Central: Mobile-First Indexing' class='text-dark fw-bold text-decoration-underline'>Google's Mobile Indexing Guide</a>.</p>
            ...
            <div class="col-lg-6" data-aos="fade-up">
                <div class="pitch-card p-5 border-3 border border-dark rounded-5 h-100 transition-all bg-white shadow-punchy-sm">
                    ...
                    <p class="text-muted mb-4 fs-5">Your business is unique, and your website should be too. We avoid generic templates in favor of <strong>Customized Designs</strong> that capture your <a href='<?= BASE_URL ?>services/branding' title='Explore our Branding Services' class='text-accent-dynamic fw-bold'>Brand Personality</a>. We work closely with you to ensure every visual element aligns with your core values, much like our successful <a href='<?= BASE_URL ?>work' title='Browse our Case Study Portfolio' class='text-dark fw-bold text-decoration-underline'>Portfolio Projects</a>.</p>
            ...
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                <div class="pitch-card p-5 border-3 border border-dark rounded-5 h-100 transition-all bg-light">
                    ...
                    <p class="text-muted mb-4 fs-5">Speed is the foundation of trust. Our websites are engineered to be <strong>Lightning Fast</strong>, with a focus on sub-second load times. We optimize everything from server-side scripts to client-side assets, ensuring your <a href='<?= BASE_URL ?>services/seo' title='Explore our SEO Services' class='text-accent-dynamic fw-bold'>SEO Rankings</a> soar. Check your current speed on <a href='https://pagespeed.web.dev/' target='_blank' rel='noopener noreferrer' title='External Tool: Google PageSpeed Insights' class='text-dark fw-bold text-decoration-underline'>PageSpeed Insights</a>.</p>
                ...
                <div class="pitch-card p-5 border-3 border border-dark rounded-5 transition-all bg-dark text-white shadow-accent">
                    <div class="row align-items-center">
                        <div class="col-lg-8">
                            ...
                            <p class="text-white opacity-75 mb-4 fs-5">Don't just launch; dominate. We build <strong>SEO-Friendly Websites</strong> from the ground up, ensuring that search engines love your site. Our architecture follows <a href='https://schema.org/' target='_blank' rel='noopener noreferrer' title='External Resource: Schema.org Documentation' class='text-accent-dynamic fw-bold text-decoration-none'>Schema.org Best Practices</a> and integrates seamlessly with our <a href='<?= BASE_URL ?>services/marketing' title='Explore our Performance Marketing' class='text-accent-dynamic fw-bold'>Full-Scale Marketing Campaigns</a>.</p>
                        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                <div class="p-5 border-2 border border-dark rounded-5 h-100 bg-white shadow-punchy-sm">
                    ...
                    <p class="small text-muted mb-0">Secure higher <a href='<?= BASE_URL ?>services/seo' class='text-dark fw-bold'>Local SEO Rankings</a>. Connect with nearby customers, increase foot traffic, and stand out in the map pack effortlessly.</p>
                </div>
            </div>
            ...
            <div class="col-lg-6" data-aos="fade-up">
                <div class="p-5 border-2 border border-dark rounded-5 h-100 bg-dark text-white">
                    ...
                    <p class="small opacity-75 mb-0">Boost credibility with accurate <a href='<?= BASE_URL ?>services/marketing' class='text-white fw-bold'>Business Listings</a> and strategic local backlinks that signal authority to Google's proximity algorithms.</p>
                </div>
            </div>
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                <div class="p-5 border-2 border border-dark rounded-5 h-100 bg-white border-accent-dynamic">
                    ...
                    <p class="small text-muted mb-0">Maximize your <a href='https://www.google.com/business/' target='_blank' rel='noopener noreferrer' class='text-dark fw-bold'>Google My Business</a> profile. We enhance rankings with tailored updates, image optimization, and review management strategies.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-6" data-aos="fade-right">
                <div class="p-2 bg-white border border-dark border-3 rounded-5 shadow-punchy-sm">
                    <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=800&q=80" alt="Professional Website Development and Business Growth in India" title="Crea8ve Cool — Scalable Web Engineering and ROI Growth" class="img-fluid rounded-4">
                </div>
            </div>
            <div class="col-lg-6" data-aos="fade-left">
                ...
                <p class="fs-5 text-muted mb-4">Your website is more than a digital presence—it’s your <strong>growth engine</strong>. We design innovative, user-focused platforms that captivate audiences, enhance <strong>User Experience</strong>, and drive measurable results. At Crea8ve Cool, we understand that whether you're a startup or an established enterprise, your <a href='<?= BASE_URL ?>services/website' class='text-dark fw-bold text-decoration-underline' title="Explore our High-Performance Website Designing and Development services">Custom Web Solution</a> must ensure you stand out, attract customers, and turn clicks into conversions.</p>
                <p class="fs-5 text-muted mb-5">Let's grow together by leveraging our expertise in <a href='<?= BASE_URL ?>services/marketing' title='Scale with Performance Marketing' class='text-accent-dynamic fw-bold'>Performance Marketing</a> and <strong>Conversion Rate Optimization (CRO)</strong>. We focus on the intersection of brand identity and technical excellence, as seen in our <a href='<?= BASE_URL ?>work' title='View Featured Projects' class='text-dark fw-bold text-decoration-underline'>Featured Case Studies</a>.</p>
    ...
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-12" data-aos="fade-up">
                <h2 class="display-4 fw-900 text-dark mb-5 text-center">Drive Success with the <span class="text-accent-dynamic">Best Website Development in <?= htmlspecialchars($locationContext) ?></span></h2>
            </div>
            <div class="col-lg-6" data-aos="fade-right">
                ...
                <p class="fs-5 text-muted">Crea8ve Cool focuses on creating brilliant websites that attract your target audience and keep them engaged. We understand the specific challenges facing businesses today—from tight <a href='<?= BASE_URL ?>services/marketing' class='text-accent-dynamic fw-bold' title="Explore our Performance Marketing and Lead Generation services">Marketing Budgets</a> to tough global competition and the urgency for quick, measurable outcomes. Our strategy is aimed at meeting these needs while maximizing long-term productivity and <a href='<?= BASE_URL ?>services/seo' class='text-accent-dynamic fw-bold' title="Explore our Organic SEO and Domain Domination services">Organic Growth</a>.</p>
            </div>
            <div class="col-lg-6" data-aos="fade-left">
                <div   class="p-5 border-3 border border-dark rounded-5 text-white shadow-punchy-lg position-relative overflow-hidden auth-card-dark">
                    ...
                    <p class="mb-4 text-white position-relative z-1 text-auth-p">As a top-tier provider of <strong>Website Development Services in <?= htmlspecialchars($locationContext) ?></strong>, we understand the unique needs of scaling brands. From bold, eye-catching visuals to easy-to-navigate layouts, we make sure your website reflects the true identity and values of your business.</p>
                    <p class="text-white position-relative z-1 text-auth-p">Our <a href='<?= BASE_URL ?>services/pwa' class='text-white fw-bold text-decoration-underline' title="Explore our Mobile-First Progressive Web App services">Mobile-First Design Approach</a> ensures your site functions perfectly on all devices, providing every user with a seamless experience. We integrate modern trends in design, <a href='https://web.dev/vitals/' target='_blank' rel='noopener noreferrer' class='text-accent-dynamic fw-bold text-decoration-none' title="Learn about Google's Core Web Vitals speed guidelines on web.dev">Google Web Vitals Optimization</a>, and intuitive use into every production.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row align-items-center g-5">
            <div class="col-lg-6 order-2 order-lg-1" data-aos="fade-right">
                ...
                <p class="fs-5 text-muted mb-4">Crea8ve Cool represents the distinctness of your business while delivering measurable success. We have worked hard to gain the trust of our clients by offering top-notch <a href='<?= BASE_URL ?>services/website' class='text-dark fw-bold text-decoration-underline' title="Explore our High-Performance Website Designing and Development services">Web Engineering Services</a>. We understand your needs, challenges, and dreams, and we blend creativity with absolute technical competence.</p>
            ...
            <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left">
                <div class="p-2 bg-white border border-dark border-3 rounded-5 shadow-punchy-sm">
                    <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=800&q=80" alt="Our Expert Team of Designers and Web Engineers" title="Crea8ve Cool — Building Trust through Technical Excellence" class="img-fluid rounded-4">
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="sc-card-body">
                                ...
                                <div class="sc-item">
                                    ...
                                    <div>
                                        ...
                                        <div class="sc-item-desc">Organising info architecture for <a href='<?= BASE_URL ?>services/seo' class='fw-bold' class="text-accent-only">SEO dominance</a> &amp; crawl depth.</div>
                                    </div>
                                </div>
...
<section id="performance" class="seo-rich-content section-padding bg-light position-relative overflow-hidden">
    <div class="container">
        <div class="authority-content-wrapper mb-0">
            ...
            <div class="row g-5">
                    <div class="col-lg-6" data-aos="fade-right">
                        <p class="fs-5">Speed is the ultimate trust signal. In a world of <a href='<?= BASE_URL ?>services/api' class='text-accent-dynamic fw-bold'>Instant API Integrations</a> and 5G connections, a slow website is a dead website. Our <strong>Web Development</strong> process follows the 'Zero-Bloat' methodology.</p>
        ...
        <div class="authority-content-wrapper mb-0">
            <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-7 order-1 order-lg-2" data-aos="fade-left">
                        ...
                        <p>Your business deserves more than a 'plug-and-play' solution. Our <strong>Custom Web Engineering</strong> ensures that you have total control over your digital asset. We provide a custom <a href='<?= BASE_URL ?>services/automation' class='text-accent-dynamic fw-bold' title="Explore our Custom Business Workflow Automation services">Admin Panel</a> that is lightweight and specifically designed for your business workflows.</p>
                        <p>Whether you need to integrate a <a href='<?= BASE_URL ?>services/crm' class='text-accent-dynamic fw-bold' title="Explore our Bespoke CRM and Lead Management Systems">Custom CRM</a>, an <a href='<?= BASE_URL ?>services/erp' class='text-accent-dynamic fw-bold' title="Explore our Custom ERP and Business Process Management software">ERP System</a>, or a complex <strong>LMS Platform</strong>, our API-first logic makes it possible. We don't believe in digital limitations — if you can dream it, we can engineer it.</p>
        ...
        <div class="authority-content-wrapper mb-0">
            <div class="text-center mb-5" data-aos="fade-up">
                ...
                <div class="premium-faq-wrapper mx-auto max-w-900" id="premiumGlossary">
                    <?php 
                    $glossary = [
                        ['q'=>'What is Responsive Web Design?', 'a'=>'<strong>Responsive Web Design (RWD)</strong> ensures your site ranks highly on Google mobile-first indexing by flawlessly adapting to any screen size. A must-have for <a href="<?= BASE_URL ?>services/seo" class="text-accent-dynamic fw-bold">SEO rankings</a>.'],
                        ...
                        ['q'=>'What is the difference between UI and UX?', 'a'=>'<strong>UI (User Interface)</strong> is the look—buttons, colours, fonts. <strong>UX (User Experience)</strong> is the feel. Our <a href="<?= BASE_URL ?>services/uiux" class="text-accent-dynamic fw-bold">UI/UX Team</a> merges both to create high-converting digital journeys.'],
                        ['q'=>'Do I really need an SSL Certificate?', 'a'=>'Absolutely. <strong>SSL (Secure Sockets Layer)</strong> encrypts your site. Without it, browsers flag you as "Not Secure". We include military-grade SSL in our <a href="<?= BASE_URL ?>services/automation" class="text-accent-dynamic fw-bold">Security Automation</a> packages.'],
                        ['q'=>'What is a CMS and why should I care?', 'a'=>'A <strong>CMS (Content Management System)</strong> lets you edit content without code. We build custom, lightweight dashboards to manage your <a href="<?= BASE_URL ?>work" class="text-accent-dynamic fw-bold">Portfolio</a> cleanly and securely.']
                    ];
                ...
                <div class="p-5 border-3 border border-dark rounded-5 bg-dark text-white shadow-punchy-lg">
                    <div class="row align-items-center">
                        <div class="col-lg-8">
                            ...
                            <p class="text-updates">Regular updates are essential to keep your website relevant, secure, and functional. We monitor analytics to identify improvement areas, fix broken links, and update security protocols to maintain absolute user trust. Add fresh content and modern design elements to stay competitive in an evolving digital landscape.</p>
                        </div>
    ...
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up">
                <div class="price-card h-100 p-4 border-3 border border-dark rounded-5 bg-white position-relative <?= $pkg['recommended'] ? 'recommended' : '' ?>" style="--pkg-color: <?= $pkg['color'] ?>;">
                    ...
                    <div class="mb-4">
                        ...
                        <h3   class="fw-900 mb-1 text-pkg-color"><?= $pkg['name'] ?></h3>
...
<!-- Geographic SEO Coverage Directory -->
<section class="py-5" style="background: #fff; border-top: 3.5px solid #111; margin-top: 80px;">
    <div class="container" style="max-width: 1240px;">
        <div class="row align-items-center mb-4" data-aos="fade-up">
            <div class="col-md-6">
                <h3 class="font-clash fw-900 text-uppercase text-dark mb-1" style="letter-spacing: -0.5px;">Global & Domestic Hubs</h3>
                <p class="text-muted small mb-0">Explore our premium website designing & digital product engineering coverage regions.</p>
            </div>
        ...
        <div class="row g-3" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="col-lg-3 col-md-4 col-6">
                <a href="<?= BASE_URL ?>services/website/<?= $key ?>" class="text-decoration-none" title="Bespoke Website Designing in <?= htmlspecialchars($loc['name']) ?>">
...
.hover-translate-up:hover {
    ...
    box-shadow: 6px 6px 0px #6A5AE0 !important;
    border-color: #111 !important;
}
.shadow-punchy-accent {
    box-shadow: 4px 4px 0px #6A5AE0 !important;
}
</style>
