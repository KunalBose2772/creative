...
$data['page_subtitle'] = "We don't just design websites—we build high-performance assets that grow your business. See how our smart workflow and experienced team can help you succeed.";
        ...
        <div class="row g-4 bento-grid">
            <div class="col-lg-6" data-aos="fade-up">
                <div class="bento-card p-5 h-100 bg-glossy-black text-white">
                    ...
                    <h3 class="display-6 fw-900 mb-4">Design & Tech <br>Excellence.</h3>
                    <p class="opacity-60 fs-5 mb-0">While many agencies only focus on looks, we combine beautiful design with high-performance coding. Every detail of your project is built to attract customers and load fast.</p>
                </div>
            </div>
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                <div class="bento-card p-5 h-100">
                    <span class="badge bg-light text-dark text-uppercase mb-3">Transparency</span>
                    <h3 class="display-6 fw-900 mb-4 text-dark">Zero Jargon. <br>Just Results.</h3>
                    <p class="text-muted fs-5 mb-0">We don't hide behind complex marketing jargon. You get direct access to our team, clear progress updates, and simple weekly reports that show exactly how your business is growing.</p>
                </div>
            </div>
