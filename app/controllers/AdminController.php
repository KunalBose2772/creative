            ...
            if (isset($_POST['p_name'])) {
                foreach ($_POST['p_name'] as $i => $name) {
                    $packages[] = [
                        ...
                        'tagline' => $_POST['p_tagline'][$i] ?? '',
                        'description' => $_POST['p_desc'][$i] ?? '',
                        'original_price' => $_POST['p_original_price'][$i] ?? '',
                        'savings' => $_POST['p_savings'][$i] ?? '',
                        'color' => $_POST['p_color'][$i] ?? '',
                        'recommended' => $_POST['p_recommended'][$i] ?? 0
                    ];
                }
            }
